...
function InfoRow({ label, value }) {
    return (
        <div className="flex items-center justify-between px-8 py-5">
            <span className="text-[2.2vh] text-gray-400">{label}</span>
            <span className="text-[2.2vh] text-white font-medium tabular-nums">{value}</span>
        </div>
    );
}
        ...
        <div className="flex justify-center items-center h-full">
            <div className="flex flex-col items-center">
                <div className="relative">
                    <div className="absolute -inset-8 rounded-full bg-brew-cyan/15 blur-3xl" />
                    <img src={TBLogo} className="relative h-[20vh] w-auto" />
                </div>
                <p className="text-white text-[4.5vh] font-semibold tracking-tight mt-8">
                    TizenBrew
                </p>
                <p className="text-[2vh] text-gray-500 mt-2 tracking-widest uppercase">
                    {t('about.tagline')}
                </p>
