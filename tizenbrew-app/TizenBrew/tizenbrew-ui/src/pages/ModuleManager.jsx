    ...
    return (
        <div className="relative isolate lg:px-8">
            <div className="mx-auto flex flex-wrap justify-center gap-4 top-4 relative">
                ...
                <Tile onClick={() => loc.route('/tizenbrew-ui/dist/index.html/module-manager/add?type=npm')}
                    extra='flex flex-col items-center justify-center gap-5'>
                    <PlusIcon className='h-[5vh] w-[5vh] text-brew-amber' />
                    <h3 className='text-brew-amber text-[2.6vh] font-semibold'>
                        {t('moduleManager.addNPM')}
                    </h3>
                    <p className='text-gray-400 text-[2vh] leading-relaxed text-center'>
                        {t('moduleManager.addNPMDesc')}
                    </p>
                </Tile>
                <Tile onClick={() => loc.route('/tizenbrew-ui/dist/index.html/module-manager/add?type=gh')}
                    extra='flex flex-col items-center justify-center gap-5'>
                    <PlusIcon className='h-[5vh] w-[5vh] text-brew-cyan' />
                    <h3 className='text-brew-cyan text-[2.6vh] font-semibold'>
...
function AddModule() {
    ...
    return (
        <div className="relative isolate lg:px-8">
            <div className="mx-auto flex flex-wrap justify-center gap-4 top-4 relative">
                <div className={classNames(TILE_BASE, '!w-[38vw] !h-[24vh] flex items-center justify-center')}>
                    <input
                        type="text"
                        ref={ref}
                        value={name}
                        className="w-full p-4 rounded-xl bg-ink-900/80 ring-1 ring-white/15 text-white text-[2.4vh] placeholder:text-gray-500 focus:outline-none"
