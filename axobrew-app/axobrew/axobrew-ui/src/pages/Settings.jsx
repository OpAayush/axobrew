    ...
    return (
        <div className="relative isolate lg:px-8">
            <div className="mx-auto flex flex-wrap justify-center gap-4 top-4 relative">
                <SettingTile
                    shouldFocus={true}
                    icon={<RocketLaunchIcon className='h-[calc(var(--uh)*4.5)] w-[calc(var(--uh)*4.5)] text-brew-cyan' />}
                    ...
                    onClick={() => {
                        ...
                        loc.route('/axobrew-ui/dist/index.html/settings/change?type=autolaunch');
                    }}
                />
                <SettingTile
                    icon={<ArrowPathIcon className='h-[calc(var(--uh)*4.5)] w-[calc(var(--uh)*4.5)] text-brew-cyan' />}
                    title={t('settings.autolaunchService')}
                    desc={t('settings.autolaunchServiceDesc')}
                    onClick={() => {
                        if (state.sharedData.modules?.length === 0) return alert(t('settings.noModules'));
                        loc.route('/axobrew-ui/dist/index.html/settings/change?type=autolaunchService');
                    }}
                />
                <SettingTile
                    icon={<Cog6ToothIcon className='h-[calc(var(--uh)*4.5)] w-[calc(var(--uh)*4.5)] text-brew-amber' />}
                    title={t('settings.useragent')}
                    desc={t('settings.useragentDesc')}
                    onClick={() => {
                        loc.route('/axobrew-ui/dist/index.html/settings/change-ua');
                    }}
                />
                <SettingTile
                    icon={<GlobeAltIcon className='h-[calc(var(--uh)*4.5)] w-[calc(var(--uh)*4.5)] text-brew-cyan' />}
                    title={t('settings.language')}
                    desc={t('settings.languageDesc')}
                    onClick={() => {
                        loc.route('/axobrew-ui/dist/index.html/settings/language');
                    }}
                />
                <SettingTile
                    icon={<ServerIcon className='h-[calc(var(--uh)*4.5)] w-[calc(var(--uh)*4.5)] text-brew-cyan' />}
        ...
        <div className="relative isolate lg:px-8">
            <div className="mx-auto flex flex-wrap justify-center gap-4 top-4 relative">
                ...
                <Tile
                    ...
                    <h3 className='text-red-400 text-[calc(var(--uh)*2.6)] font-semibold'>
